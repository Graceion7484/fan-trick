 ...
 */
 ...
 const REPRO_COST = 1250; // cost of reproductions rights
 const TRAVEL_COST = 2; // cost oftravel per mile

// setup the forms when the pages
...
function getEstimate(){
     ...
     // Add the cost of photoRights if purchased
     totalCost += buyRights ? REPRO_COST : 0;

     //Display the total esitmate
